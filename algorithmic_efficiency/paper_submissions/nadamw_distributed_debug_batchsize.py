...
def update_params(workload: spec.Workload,
  ...
  if RANK == 0:  # log only on rank 0
    ...
    print(f"Before GGN1: Driver-level free: {free/1024**2:.1f} MiB of {total/1024**2:.1f} MiB")
    print(f"Before GGN1: Max allocated: {torch.cuda.max_memory_allocated(device=DEVICE) / 1024**2:.1f} MiB")
  ...
  if RANK == 0:  # log only on rank 0
    free, total = torch.cuda.mem_get_info()
    print(f"After GGN1: Driver-level free: {free/1024**2:.1f} MiB of {total/1024**2:.1f} MiB")
    print(f"After GGN1: Max allocated: {torch.cuda.max_memory_allocated(device=DEVICE) / 1024**2:.1f} MiB")
  ...
  if RANK == 0:  # log only on rank 0
    free, total = torch.cuda.mem_get_info()
    print(f"Before GGN2: Driver-level free: {free/1024**2:.1f} MiB of {total/1024**2:.1f} MiB")
    print(f"Before GGN2: Max allocated: {torch.cuda.max_memory_allocated(device=DEVICE) / 1024**2:.1f} MiB")
