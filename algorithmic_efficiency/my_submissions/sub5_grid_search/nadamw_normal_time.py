...
def update_params(workload: spec.Workload,
  ...
  log_dir = os.path.expandvars("$WORK/cluster_experiments/nadamw_normal_time")
  ...
  log_data = [global_step, current_lr, loss.item()]
  ...
  try:
      with open(log_file_path, 'x') as log_file:  # Open in exclusive creation mode
          ...
          writer.writerow(["Global step", "Learning rate", "Loss"
                          ])  # Write header
