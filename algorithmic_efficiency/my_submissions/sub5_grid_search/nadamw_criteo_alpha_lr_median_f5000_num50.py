...
def update_params(workload: spec.Workload,
  ...
  log_dir = os.path.expandvars("$WORK/cluster_experiments/time_f5000_num50")
  ...
  if (adjusted_step % comp_alphas_each == num_consec_alphas - 1 and global_step > comp_alphas_each) or global_step == 2049:
