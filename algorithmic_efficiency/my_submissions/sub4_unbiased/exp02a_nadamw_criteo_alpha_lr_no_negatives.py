...
def update_params(workload: spec.Workload,
  ...
  log_dir = os.path.expandvars("/home/suckrowd/Documents/experiments/exp02a_1501_mnist_no_negatives")  # Change this to the desired directory
  ...
  if global_step % 50 == 49 and global_step > 1000:
    averaged_alpha_star1 = summed_alpha_star1/count_pos_alphas
    ...
    for i, param_group in enumerate(optimizer_state['optimizer'].param_groups):
        ...
        print("Count of used alphas: ", count_pos_alphas)
